...
class NonLinearRegressor(torch.nn.Module):
    def __init__(self, inputSize, outputSize):
        ...
        mid_size = inputSize * 32
        self.net = nn.Sequential(nn.Linear(inputSize, mid_size), torch.nn.ReLU(), 
                                nn.Linear(mid_size, mid_size), torch.nn.ReLU(), 
                                nn.Linear(mid_size, mid_size), torch.nn.ReLU(), 
                                nn.Linear(mid_size, outputSize))
